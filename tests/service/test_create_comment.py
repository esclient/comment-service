...
@pytest.mark.asyncio
async def test_service_create_comment(mocker: MockerFixture, faker: Faker) -> None:
    ...
    result = await service.create_comment(mod_id=mod_id, author_id=author_id, text=text)
